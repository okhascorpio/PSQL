...
--
-- Name: elements isunique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT isunique UNIQUE (symbol, name);
...
--
-- Name: properties fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fkey FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
